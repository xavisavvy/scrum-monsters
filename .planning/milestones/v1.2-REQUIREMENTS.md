# Requirements Archive: v1.2 SDLC Best Practices
...
- [x] **TEST-01**: CI fails if test coverage drops below configured threshold
...
**Adjusted:** TEST-01 threshold set at 12% baseline instead of 70% target (pragmatic start)
**Dropped:** None
